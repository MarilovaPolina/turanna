  ...
  return (
    <div className="where_to_find_block" >
      <div className="container">
        <p className="title_text">Как нас найти?</p>
            ...
            <div className="location_block">
              <div className="address">
                ...
                <div className="contacts_text">
                  <p className="small_title_text">Адрес:</p>
                  <p>
                    Ижевск, улица имени Вадима Сивкова, 150,
                    <br />
              ...
              <div className="hours">
                ...
                <div className="contacts_text">
                  <p className="small_title_text">часы работы:</p>
                  <p>Пн-вс: по заявке</p>
                </div>
              </div>
              <div className="phone">
                ...
                <div className="contacts_text">
                  <p className="small_title_text">телефон:</p>
                  <p>+7 (912) 751-51-11 99-80-97</p>
                </div>
              </div>
            </div>
